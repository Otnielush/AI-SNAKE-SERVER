...
func runMaster(args *cli.Context) error {
	...
	log.Println("AISNAKE master server web content directory", webDir)
	log.Println("AISNAKE master listen address", listen)
...
func runMap(args *cli.Context) error {
	...
	log.Println("Current map server listen address", listen)
	log.Println("Remote master server address", masterAddr)
